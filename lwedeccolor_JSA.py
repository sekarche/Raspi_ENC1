...
if __name__ == "__main__":
    im = Image.open('C:/Users/NIT CSE/Desktop/desktop 2/comp comm python code/lenaencclr.png')
    ...
    merged.save('C:/Users/NIT CSE/Desktop/desktop 2/comp comm python code/lenadecclr.png')
    merged.show()
    #ime = Image.open('enc2.png') 
    #ime.show()
    #imr.show()
